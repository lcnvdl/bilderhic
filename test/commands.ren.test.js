...
describe("RenCommand", () => {
  ...
  afterEach(() => {
    if (fs.existsSync(path.join(folder, "./files/ren.txt"))) fs.unlinkSync(path.join(folder, "./files/ren.txt"));
    if (fs.existsSync(path.join(folder, "./files/ren2.txt"))) fs.unlinkSync(path.join(folder, "./files/ren2.txt"));
    if (fs.existsSync(path.join(folder, "./files/ren3.txt"))) fs.unlinkSync(path.join(folder, "./files/ren3.txt"));
  });
